...
class ProductCommentViewState extends State<ProductCommentView> {
  late ProductCommentViewModel productCommentViewModel;
                                    ...
                                    child: Padding(
                                      ...
                                      child: RichText(
                                        text: TextSpan(style: TextStyle(color: Colors.black, fontSize: 12.0, fontWeight: FontWeight.bold), children: [
                                          TextSpan(
                                              text: 'FİYAT / PERFORMANS: ' +
                                                  productCommentViewModel.productComments![index].pricePerformance.toString())
                                        ]),
                                      ),
                                    ),
                                  ),
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          productCommentViewModel
                                              .gotoCommentatorNavigate(productCommentViewModel.productComments![index].customerId!);
                                        },
                                        child: RichText(
                                          text: TextSpan(
                                              style: TextStyle(color: mainColor, fontSize: 15.0, fontWeight: FontWeight.bold),
                                  ...
                                  Expanded(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: RichText(
                                          text: TextSpan(style: TextStyle(color: Colors.grey, fontSize: 8.0, fontWeight: FontWeight.bold), children: [
                                            TextSpan(text: CoreHelper.parseDateData(productCommentViewModel.productComments![index].createdDate!))
                                          ]),
                                        ),
                                      ),
                                    ),
