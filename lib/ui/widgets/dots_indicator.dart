...
import 'package:tadayim_bunu/ui/widgets/dots_decarator.dart';
...
class DotsIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return axis == Axis.vertical ? Column(mainAxisSize: MainAxisSize.min, children: dots) : Row(mainAxisSize: MainAxisSize.min, children: dots);
  }
}
